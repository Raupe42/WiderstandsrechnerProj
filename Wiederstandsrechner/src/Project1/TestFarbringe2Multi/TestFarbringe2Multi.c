...
task: Dieses Programm soll die Funktiondouble farbringe2Multi (..)
testen.
...
int main(void)
{
	...
	printf("Testen der Funktion int farbing2Multi (..)\n");
	for (i = 0; i < INPUTn; i++)
	{
		printf("In:       %s\n", inputs[i]);
...
es werden nur kleingeschriebene Eingaben erwartet,
